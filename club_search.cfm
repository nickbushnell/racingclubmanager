	...
	<table border="0" cellspacing="0" cellpadding="0" style="background-color: #263248;">
		...
		<tr>
			...
			<td>
				<table width="100%" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="right">
							...
							<a href="javascript:parent.showClubSearch(true);">View All Clubs</a>
						</td>
					</tr>
				</table>
				...
				<!--<img src="imgs/mag.png" height="16" title="Click on a Club Name from the results." />-->
			</td>
			<td>
